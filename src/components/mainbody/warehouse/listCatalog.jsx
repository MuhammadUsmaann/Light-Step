            ...
            <div className="card-header border-0 bg-white" id="heading0">
              <h3 className="mb-0">
                <div
                  ...
                  data-target="#listcatalogcollapse0"
                  aria-expanded="false"
                  aria-controls="listcatalogcollapse0"
                >
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p className="font-18 font-weight-600">list-catalog</p>
                    </div>
                  </div>
                </div>
              </h3>
