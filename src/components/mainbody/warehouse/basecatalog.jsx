...
const mostChanges = [
  ...
  },
  {
    ...
    daviation:"44.22% of traces",
    change: "High",
    id: "basemorecollapse_5",
  },
];

const BaseCatalog = () => {
 
  const [showDetailattribute, setshowDetailattribute] = useState(true);
  return (
    <div className="py-4">
      <div className="">
        <div id="accordion">
          <div className="card">
            <div className="card-header border-0 bg-white" id="heading0">
              <h3 className="mb-0">
                <div
                  ...
                  data-target="#basecatalogcollapse0"
                  aria-expanded="false"
                  aria-controls="basecatalogcollapse0"
                >
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p className="font-18 font-weight-600">base-catalog</p>
                    </div>
                  </div>
                </div>
              </h3>
            ...
            >
              ...
              {performanceChanges.map((data) => {
                ...
                <div className="border-t-default pl62px px-3 pt-3 pb-2">
                  <p className="font-18 font-weight-600 text-light-gray">
                    No significant changes found in attributes
                  </p>

                  <button
                    className={`show-more-attribute-btn ${
                      showDetailattribute ? "d-block " : "d-none"
                    }`}
                    onClick={() => {
                      setshowDetailattribute(!showDetailattribute);
                    }}
                  >
                    Show 10 more attribute with less change
                  </button>
                </div>
                <div
                  className={`most-changes ${
                    !showDetailattribute ? "d-block " : "d-none"
                  }`}
                >
